...
<body class="flex flex-col items-center triomphe">
    ...
    <div class=" flex flex-col lg:w-auto w-[90%]">
        ...
        <table class="border-[0.1vw] rounded-[0.5vw] border-[#1962A1] mb-[10vh] border-separate border-spacing-[0.5vw]">
            <thead>
                <tr>
                    <th class="table_header text-[3vw] lg:text-[1vw] triomphe">Licence</th>
                    <th class="table_header text-[3vw] lg:text-[1vw] triomphe">Nom</th>
                    <th class="table_header text-[3vw] lg:text-[1vw] triomphe">Prénom</th>
                    <th class="table_header text-[3vw] lg:text-[1vw] lg:table-cell hidden triomphe">Mail</th>
                    <th class="table_header text-[3vw] lg:text-[1vw] triomphe">Niveau</th>
